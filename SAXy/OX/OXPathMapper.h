...
//  a element, attribute or xpath description ('/contact/address/@city'). Complex
//  paths have a list of component parts starting with a 'root' node and ending with a 'leaf' node.
//
...
//  be customized or used as templates.  Blocks are passed an instance of context at run-time, allowing access to other features
